...
class KalmanFilter(object):
    ...
    def __init__(self, dim_x, dim_z):
        ...
        self.x = xxxx        # state (mean)
        self.P = xxxx        # uncertainty covariance
        self.Q = xxxx        # process uncertainty
        self.F = xxxx        # state transition matrix
        self.H = xxxx        # measurement matrix
        self.R = xxxx        # measurement uncertainty
